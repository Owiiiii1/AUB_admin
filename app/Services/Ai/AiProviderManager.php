...
class AiProviderManager
{
     ...
     */
    public function complete(string $provider, string $apiKey, string $model, array $messages, int $maxTokens = 8192): string
    {
        return $this->client($provider)->complete($apiKey, $model, $messages, $maxTokens);
    }
