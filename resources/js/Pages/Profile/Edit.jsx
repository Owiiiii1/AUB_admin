...
export default function EditProfile() {
    const { auth, locale = 'it' } = usePage().props;
    const user = auth?.user;
    const canDelete = user?.can_delete === true;
    ...
    const text = {
        it: {
            title: 'Profilo',
            subtitle: 'Gestisci i dati del tuo account e le impostazioni di sicurezza.',
            ...
            dangerText: 'Elimina l\'account in modo permanente. Questa azione non può essere annullata.',
