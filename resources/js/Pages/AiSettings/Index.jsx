...
export default function AiSettingsIndex() {
    const { providers = [], locale = 'it', errors: pageErrors, flash } = usePage().props;
    ...
    const text = {
        it: {
            ...
            subtitle: 'Collega un provider e attiva un solo modello alla volta.',
            apiKey: 'Chiave API',
            saveKey: 'Salva chiave',
            check: 'Verifica connessione',
            activate: 'Attiva',
            deactivate: 'Disattiva tutto',
            activeModel: 'Modello attivo',
            modelSelect: 'Modelli disponibili',
            noModels: 'Nessun modello caricato',
            notConnected: 'Non connesso',
            connected: 'Connesso',
            active: 'Attivo',
            error: 'Errore',
            savedMask: 'Chiave salvata',
        },
        en: {
            title: 'AI Settings',
